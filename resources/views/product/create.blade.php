                    ...
                    <form method="post" action="{{ route('product.store') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('tag') ? ' has-danger' : '' }}">
                                            <select
                                                ...
                                                @foreach($tags as $tag)
                                                    <option data-value="{{ $tag->name }}" value="{{ $tag->id }}" @if(in_array($tag->id, old('tags', []))) selected @endif >{{ $tag->name }}</option>
                                                @endforeach
                                ...
                                <div class="row">
                                    <label class="col-sm-2 col-form-label">{{ __('Variation') }}</label>
                                    <div class="col-sm-7">
