<div class="col-md-12" id="section_tag_container" style="margin-top: 20px">
        ...
        <div class="col-sm-7">
            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                <input
                        ...
                        placeholder="{{ __('Slider Name') }}" value="{{ old('name') }}"
        ...
        <div class="col-sm-7">
            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                <select class="form-control{{ $errors->has('variationOption') ? ' is-invalid' : '' }}"
                        name="style" id="input-style" required onchange="SliderSectionManager.loadSliderStyle(this.value)">
                    <option value="">Select Slider Style</option>
                    @foreach (getSliderSectionStyles() as $styles)
    ...
    <div class="row" id="load_Slider_details">
