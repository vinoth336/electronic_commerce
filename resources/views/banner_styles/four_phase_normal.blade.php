            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @php
                        $banner = optional();
                        if($bannerInfo) {
                            $banner = $bannerInfo[($i - 1)] ?? optional();
                        }
                    @endphp
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="input_section">
                                <input type="text" name="target_urls[]" class="form-control" data-required="true"  value="{{ $banner->url ?? "" }}" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="input_section">
                                <input type="text" name="banner_description[]" class="form-control" value="{{ $banner->description ?? "" }}" />
                            </td>
                        </tr>
                        <tr>
                            <td>
